...
Color::Color()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    protobuf_google_2ftype_2fcolor_2eproto::InitDefaults();
  }
  SharedCtor();
...
const ::google::protobuf::Descriptor* Color::descriptor() {
  ...
  return protobuf_google_2ftype_2fcolor_2eproto::file_level_metadata[0].descriptor;
}
...
::google::protobuf::Metadata Color::GetMetadata() const {
  protobuf_google_2ftype_2fcolor_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_google_2ftype_2fcolor_2eproto::file_level_metadata[0];
}
