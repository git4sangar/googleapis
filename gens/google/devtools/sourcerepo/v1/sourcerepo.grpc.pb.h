 ...
 public:
  ...
  class Stub final : public StubInterface {
   ...
   private:
    ...
    const ::grpc::RpcMethod rpcmethod_ListRepos_;
    const ::grpc::RpcMethod rpcmethod_GetRepo_;
    const ::grpc::RpcMethod rpcmethod_CreateRepo_;
    const ::grpc::RpcMethod rpcmethod_DeleteRepo_;
   ...
   public:
    WithStreamedUnaryMethod_ListRepos() {
      ::grpc::Service::MarkMethodStreamed(0,
        new ::grpc::StreamedUnaryHandler< ::google::devtools::sourcerepo::v1::ListReposRequest, ::google::devtools::sourcerepo::v1::ListReposResponse>(std::bind(&WithStreamedUnaryMethod_ListRepos<BaseClass>::StreamedListRepos, this, std::placeholders::_1, std::placeholders::_2)));
    }
   ...
   public:
    WithStreamedUnaryMethod_GetRepo() {
      ::grpc::Service::MarkMethodStreamed(1,
        new ::grpc::StreamedUnaryHandler< ::google::devtools::sourcerepo::v1::GetRepoRequest, ::google::devtools::sourcerepo::v1::Repo>(std::bind(&WithStreamedUnaryMethod_GetRepo<BaseClass>::StreamedGetRepo, this, std::placeholders::_1, std::placeholders::_2)));
    }
   ...
   public:
    WithStreamedUnaryMethod_CreateRepo() {
      ::grpc::Service::MarkMethodStreamed(2,
        new ::grpc::StreamedUnaryHandler< ::google::devtools::sourcerepo::v1::CreateRepoRequest, ::google::devtools::sourcerepo::v1::Repo>(std::bind(&WithStreamedUnaryMethod_CreateRepo<BaseClass>::StreamedCreateRepo, this, std::placeholders::_1, std::placeholders::_2)));
    }
   ...
   public:
    WithStreamedUnaryMethod_DeleteRepo() {
      ::grpc::Service::MarkMethodStreamed(3,
        new ::grpc::StreamedUnaryHandler< ::google::devtools::sourcerepo::v1::DeleteRepoRequest, ::google::protobuf::Empty>(std::bind(&WithStreamedUnaryMethod_DeleteRepo<BaseClass>::StreamedDeleteRepo, this, std::placeholders::_1, std::placeholders::_2)));
    }
