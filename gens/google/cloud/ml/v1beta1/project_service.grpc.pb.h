...
//
#ifndef GRPC_google_2fcloud_2fml_2fv1beta1_2fproject_5fservice_2eproto__INCLUDED
#define GRPC_google_2fcloud_2fml_2fv1beta1_2fproject_5fservice_2eproto__INCLUDED
 ...
 public:
  class StubInterface {
   public:
    ...
    virtual ::grpc::Status GetConfig(::grpc::ClientContext* context, const ::google::cloud::ml::v1beta1::GetConfigRequest& request, ::google::cloud::ml::v1beta1::GetConfigResponse* response) = 0;
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::google::cloud::ml::v1beta1::GetConfigResponse>> AsyncGetConfig(::grpc::ClientContext* context, const ::google::cloud::ml::v1beta1::GetConfigRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::google::cloud::ml::v1beta1::GetConfigResponse>>(AsyncGetConfigRaw(context, request, cq));
    }
  private:
  ...
  class Service : public ::grpc::Service {
   public:
    ...
    // the Google Cloud Storage location where you put your model training code
    // for training the model with Google Cloud Machine Learning.
    virtual ::grpc::Status GetConfig(::grpc::ServerContext* context, const ::google::cloud::ml::v1beta1::GetConfigRequest* request, ::google::cloud::ml::v1beta1::GetConfigResponse* response);
  };
  ...
  class WithAsyncMethod_GetConfig : public BaseClass {
   ...
   public:
    ...
    void RequestGetConfig(::grpc::ServerContext* context, ::google::cloud::ml::v1beta1::GetConfigRequest* request, ::grpc::ServerAsyncResponseWriter< ::google::cloud::ml::v1beta1::GetConfigResponse>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
...
#endif  // GRPC_google_2fcloud_2fml_2fv1beta1_2fproject_5fservice_2eproto__INCLUDED
