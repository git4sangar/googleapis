...
#ifndef PROTOBUF_google_2fcloud_2fml_2fv1_2foperation_5fmetadata_2eproto__INCLUDED
#define PROTOBUF_google_2fcloud_2fml_2fv1_2foperation_5fmetadata_2eproto__INCLUDED
...
class OperationMetadata : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.cloud.ml.v1.OperationMetadata) */ {
 public:
  OperationMetadata();
  ...
  ::google::cloud::ml::v1::OperationMetadata_OperationType operation_type() const;
  void set_operation_type(::google::cloud::ml::v1::OperationMetadata_OperationType value);
 ...
 private:
  ...
  friend struct  protobuf_google_2fcloud_2fml_2fv1_2foperation_5fmetadata_2eproto::TableStruct;
};
// ===================================================================
...
inline ::google::cloud::ml::v1::OperationMetadata_OperationType OperationMetadata::operation_type() const {
...
inline void OperationMetadata::set_operation_type(::google::cloud::ml::v1::OperationMetadata_OperationType value) {
...
inline const ::google::cloud::ml::v1::Version& OperationMetadata::version() const {
...
inline ::google::cloud::ml::v1::Version* OperationMetadata::mutable_version() {
...
inline ::google::cloud::ml::v1::Version* OperationMetadata::release_version() {
...
inline void OperationMetadata::set_allocated_version(::google::cloud::ml::v1::Version* version) {
  delete version_;
  version_ = version;
  if (version) {
...
template <> struct is_proto_enum< ::google::cloud::ml::v1::OperationMetadata_OperationType> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::google::cloud::ml::v1::OperationMetadata_OperationType>() {
  return ::google::cloud::ml::v1::OperationMetadata_OperationType_descriptor();
}
...
#endif  // PROTOBUF_google_2fcloud_2fml_2fv1_2foperation_5fmetadata_2eproto__INCLUDED
