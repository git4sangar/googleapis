...
inline void Job::set_allocated_training_input(::google::cloud::ml::v1::TrainingInput* training_input) {
  clear_input();
  if (training_input) {
    set_has_training_input();
...
inline void Job::set_allocated_prediction_input(::google::cloud::ml::v1::PredictionInput* prediction_input) {
  clear_input();
  if (prediction_input) {
    set_has_prediction_input();
...
inline void Job::set_allocated_training_output(::google::cloud::ml::v1::TrainingOutput* training_output) {
  clear_output();
  if (training_output) {
    set_has_training_output();
...
inline void Job::set_allocated_prediction_output(::google::cloud::ml::v1::PredictionOutput* prediction_output) {
  clear_output();
