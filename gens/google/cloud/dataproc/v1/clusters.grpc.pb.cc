...
ClusterController::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel)
  : channel_(channel), rpcmethod_CreateCluster_(ClusterController_method_names[0], ::grpc::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_UpdateCluster_(ClusterController_method_names[1], ::grpc::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_DeleteCluster_(ClusterController_method_names[2], ::grpc::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_GetCluster_(ClusterController_method_names[3], ::grpc::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_ListClusters_(ClusterController_method_names[4], ::grpc::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_DiagnoseCluster_(ClusterController_method_names[5], ::grpc::RpcMethod::NORMAL_RPC, channel)
  {}
...
::grpc::ClientAsyncResponseReader< ::google::longrunning::Operation>* ClusterController::Stub::AsyncDeleteClusterRaw(::grpc::ClientContext* context, const ::google::cloud::dataproc::v1::DeleteClusterRequest& request, ::grpc::CompletionQueue* cq) {
  return new ::grpc::ClientAsyncResponseReader< ::google::longrunning::Operation>(channel_.get(), cq, rpcmethod_DeleteCluster_, context, request);
}
...
::grpc::ClientAsyncResponseReader< ::google::cloud::dataproc::v1::Cluster>* ClusterController::Stub::AsyncGetClusterRaw(::grpc::ClientContext* context, const ::google::cloud::dataproc::v1::GetClusterRequest& request, ::grpc::CompletionQueue* cq) {
  return new ::grpc::ClientAsyncResponseReader< ::google::cloud::dataproc::v1::Cluster>(channel_.get(), cq, rpcmethod_GetCluster_, context, request);
}
...
::grpc::ClientAsyncResponseReader< ::google::cloud::dataproc::v1::ListClustersResponse>* ClusterController::Stub::AsyncListClustersRaw(::grpc::ClientContext* context, const ::google::cloud::dataproc::v1::ListClustersRequest& request, ::grpc::CompletionQueue* cq) {
  return new ::grpc::ClientAsyncResponseReader< ::google::cloud::dataproc::v1::ListClustersResponse>(channel_.get(), cq, rpcmethod_ListClusters_, context, request);
}
...
::grpc::Status ClusterController::Stub::DiagnoseCluster(::grpc::ClientContext* context, const ::google::cloud::dataproc::v1::DiagnoseClusterRequest& request, ::google::longrunning::Operation* response) {
  return ::grpc::BlockingUnaryCall(channel_.get(), rpcmethod_DiagnoseCluster_, context, request, response);
}
...
::grpc::ClientAsyncResponseReader< ::google::longrunning::Operation>* ClusterController::Stub::AsyncDiagnoseClusterRaw(::grpc::ClientContext* context, const ::google::cloud::dataproc::v1::DiagnoseClusterRequest& request, ::grpc::CompletionQueue* cq) {
  return new ::grpc::ClientAsyncResponseReader< ::google::longrunning::Operation>(channel_.get(), cq, rpcmethod_DiagnoseCluster_, context, request);
}
...
ClusterController::Service::Service() {
  AddMethod(new ::grpc::RpcServiceMethod(
      ...
      new ::grpc::RpcMethodHandler< ClusterController::Service, ::google::cloud::dataproc::v1::CreateClusterRequest, ::google::longrunning::Operation>(
          std::mem_fn(&ClusterController::Service::CreateCluster), this)));
  AddMethod(new ::grpc::RpcServiceMethod(
      ClusterController_method_names[1],
      ::grpc::RpcMethod::NORMAL_RPC,
      new ::grpc::RpcMethodHandler< ClusterController::Service, ::google::cloud::dataproc::v1::UpdateClusterRequest, ::google::longrunning::Operation>(
          std::mem_fn(&ClusterController::Service::UpdateCluster), this)));
  AddMethod(new ::grpc::RpcServiceMethod(
      ClusterController_method_names[2],
      ::grpc::RpcMethod::NORMAL_RPC,
      new ::grpc::RpcMethodHandler< ClusterController::Service, ::google::cloud::dataproc::v1::DeleteClusterRequest, ::google::longrunning::Operation>(
          std::mem_fn(&ClusterController::Service::DeleteCluster), this)));
  AddMethod(new ::grpc::RpcServiceMethod(
      ClusterController_method_names[3],
      ::grpc::RpcMethod::NORMAL_RPC,
      new ::grpc::RpcMethodHandler< ClusterController::Service, ::google::cloud::dataproc::v1::GetClusterRequest, ::google::cloud::dataproc::v1::Cluster>(
          std::mem_fn(&ClusterController::Service::GetCluster), this)));
  AddMethod(new ::grpc::RpcServiceMethod(
      ClusterController_method_names[4],
      ::grpc::RpcMethod::NORMAL_RPC,
      new ::grpc::RpcMethodHandler< ClusterController::Service, ::google::cloud::dataproc::v1::ListClustersRequest, ::google::cloud::dataproc::v1::ListClustersResponse>(
          std::mem_fn(&ClusterController::Service::ListClusters), this)));
  AddMethod(new ::grpc::RpcServiceMethod(
      ClusterController_method_names[5],
      ::grpc::RpcMethod::NORMAL_RPC,
      new ::grpc::RpcMethodHandler< ClusterController::Service, ::google::cloud::dataproc::v1::DiagnoseClusterRequest, ::google::longrunning::Operation>(
