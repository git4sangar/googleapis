...
inline void ListSupportAccountsResponse::clear_accounts() {
  accounts_.Clear();
}
...
inline void ListCasesResponse::clear_cases() {
  cases_.Clear();
}
...
inline void CreateCaseRequest::clear_case_() {
...
inline void UpdateCaseRequest::clear_case_() {
  if (GetArenaNoVirtual() == NULL && case__ != NULL) delete case__;
  case__ = NULL;
}
...
inline void UpdateCaseRequest::clear_update_mask() {
...
inline void CreateCommentRequest::clear_comment() {
