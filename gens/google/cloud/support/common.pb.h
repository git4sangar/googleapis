...
inline void SupportAccount::clear_create_time() {
...
inline void Case::clear_create_time() {
  if (GetArenaNoVirtual() == NULL && create_time_ != NULL) delete create_time_;
  create_time_ = NULL;
}
...
inline void Case::clear_update_time() {
...
inline void CustomerIssue::clear_create_time() {
  if (GetArenaNoVirtual() == NULL && create_time_ != NULL) delete create_time_;
  create_time_ = NULL;
}
...
inline void CustomerIssue::clear_resolve_time() {
...
inline void CustomerIssue::clear_update_time() {
  if (GetArenaNoVirtual() == NULL && update_time_ != NULL) delete update_time_;
  update_time_ = NULL;
}
