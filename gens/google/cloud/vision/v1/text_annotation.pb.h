...
class TextAnnotation_TextProperty : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.cloud.vision.v1.TextAnnotation.TextProperty) */ {
 public:
  ...
  void _slow_set_allocated_detected_break(
      ::google::protobuf::Arena* message_arena, ::google::cloud::vision::v1::TextAnnotation_DetectedBreak** detected_break);
  ::google::cloud::vision::v1::TextAnnotation_DetectedBreak* _slow_release_detected_break();
  public:
...
class Page : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.cloud.vision.v1.Page) */ {
 public:
  ...
  void _slow_set_allocated_property(
      ::google::protobuf::Arena* message_arena, ::google::cloud::vision::v1::TextAnnotation_TextProperty** property);
  ::google::cloud::vision::v1::TextAnnotation_TextProperty* _slow_release_property();
  public:
...
class Block : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.cloud.vision.v1.Block) */ {
 public:
  ...
  ::google::cloud::vision::v1::BoundingPoly* _slow_release_bounding_box();
  public:
...
inline void Block::clear_bounding_box() {
...
inline void Paragraph::clear_bounding_box() {
  if (GetArenaNoVirtual() == NULL && bounding_box_ != NULL) delete bounding_box_;
  bounding_box_ = NULL;
}
...
inline void Word::clear_bounding_box() {
  if (GetArenaNoVirtual() == NULL && bounding_box_ != NULL) delete bounding_box_;
  bounding_box_ = NULL;
}
...
inline void Symbol::clear_bounding_box() {
  if (GetArenaNoVirtual() == NULL && bounding_box_ != NULL) delete bounding_box_;
  bounding_box_ = NULL;
}
