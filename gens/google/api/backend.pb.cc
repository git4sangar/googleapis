...
static ::google::protobuf::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::google::protobuf::Message*>(&_Backend_default_instance_),
  reinterpret_cast<const ::google::protobuf::Message*>(&_BackendRule_default_instance_),
};
...
Backend::Backend()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    protobuf_google_2fapi_2fbackend_2eproto::InitDefaults();
  }
  SharedCtor();
...
const ::google::protobuf::Descriptor* Backend::descriptor() {
  ...
  return protobuf_google_2fapi_2fbackend_2eproto::file_level_metadata[0].descriptor;
}
...
::google::protobuf::Metadata Backend::GetMetadata() const {
  protobuf_google_2fapi_2fbackend_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_google_2fapi_2fbackend_2eproto::file_level_metadata[0];
}
...
const ::google::protobuf::Descriptor* BackendRule::descriptor() {
  protobuf_google_2fapi_2fbackend_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_google_2fapi_2fbackend_2eproto::file_level_metadata[1].descriptor;
}
...
::google::protobuf::Metadata BackendRule::GetMetadata() const {
  protobuf_google_2fapi_2fbackend_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_google_2fapi_2fbackend_2eproto::file_level_metadata[1];
}
...
#if LANG_CXX11
void BackendRule::set_selector(::std::string&& value) {
...
#if LANG_CXX11
void BackendRule::set_address(::std::string&& value) {
