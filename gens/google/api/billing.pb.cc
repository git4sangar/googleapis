...
const ::google::protobuf::Descriptor* Billing::descriptor() {
  ...
  return protobuf_google_2fapi_2fbilling_2eproto::file_level_metadata[0].descriptor;
}
...
::google::protobuf::Metadata Billing::GetMetadata() const {
  protobuf_google_2fapi_2fbilling_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_google_2fapi_2fbilling_2eproto::file_level_metadata[0];
}
...
const ::google::protobuf::Descriptor* BillingStatusRule::descriptor() {
  protobuf_google_2fapi_2fbilling_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_google_2fapi_2fbilling_2eproto::file_level_metadata[1].descriptor;
}
...
::google::protobuf::Metadata BillingStatusRule::GetMetadata() const {
  protobuf_google_2fapi_2fbilling_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_google_2fapi_2fbilling_2eproto::file_level_metadata[1];
}
