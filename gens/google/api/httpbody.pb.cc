...
namespace google {
namespace api {
class HttpBodyDefaultTypeInternal : public ::google::protobuf::internal::ExplicitlyConstructed<HttpBody> {
...
static ::google::protobuf::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::google::protobuf::Message*>(&_HttpBody_default_instance_),
};
...
void protobuf_AssignDescriptors() {
  ...
  AssignDescriptors(
      "google/api/httpbody.proto", schemas, file_default_instances, TableStruct::offsets, factory,
...
void TableStruct::Shutdown() {
  _HttpBody_default_instance_.Shutdown();
...
void TableStruct::InitDefaultsImpl() {
  ...
  _HttpBody_default_instance_.DefaultConstruct();
}
...
HttpBody::HttpBody()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    protobuf_google_2fapi_2fhttpbody_2eproto::InitDefaults();
  }
  SharedCtor();
...
const ::google::protobuf::Descriptor* HttpBody::descriptor() {
  ...
  return protobuf_google_2fapi_2fhttpbody_2eproto::file_level_metadata[0].descriptor;
}
...
::google::protobuf::Metadata HttpBody::GetMetadata() const {
  protobuf_google_2fapi_2fhttpbody_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_google_2fapi_2fhttpbody_2eproto::file_level_metadata[0];
}
...
#if LANG_CXX11
void HttpBody::set_content_type(::std::string&& value) {
...
#if LANG_CXX11
void HttpBody::set_data(::std::string&& value) {
