...
const ::google::protobuf::uint32 TableStruct::offsets[] = {
  ...
  PROTO2_GENERATED_DEFAULT_ONEOF_FIELD_OFFSET((&_LogEntry_default_instance_), struct_payload_),
...
void protobuf_RegisterTypes(const ::std::string&) {
  ...
  const ::google::protobuf::Descriptor* LogEntry_LabelsEntry_descriptor = protobuf_google_2fapi_2fservicecontrol_2fv1_2flog_5fentry_2eproto::file_level_metadata[0].descriptor;
...
void TableStruct::InitDefaultsImpl() {
  ...
  _LogEntry_default_instance_.struct_payload_ = const_cast< ::google::protobuf::Struct*>(
...
LogEntry::LogEntry()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    protobuf_google_2fapi_2fservicecontrol_2fv1_2flog_5fentry_2eproto::InitDefaults();
  }
  SharedCtor();
...
const ::google::protobuf::Descriptor* LogEntry::descriptor() {
  protobuf_google_2fapi_2fservicecontrol_2fv1_2flog_5fentry_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_google_2fapi_2fservicecontrol_2fv1_2flog_5fentry_2eproto::file_level_metadata[1].descriptor;
}
...
::google::protobuf::Metadata LogEntry::GetMetadata() const {
  protobuf_google_2fapi_2fservicecontrol_2fv1_2flog_5fentry_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_google_2fapi_2fservicecontrol_2fv1_2flog_5fentry_2eproto::file_level_metadata[1];
}
...
#if LANG_CXX11
void LogEntry::set_name(::std::string&& value) {
...
#if LANG_CXX11
void LogEntry::set_insert_id(::std::string&& value) {
...
#if LANG_CXX11
void LogEntry::set_text_payload(::std::string&& value) {
  // @@protoc_insertion_point(field_set:google.api.servicecontrol.v1.LogEntry.text_payload)
  if (!has_text_payload()) {
    clear_payload();
    set_has_text_payload();
