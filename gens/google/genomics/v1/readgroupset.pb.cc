...
void protobuf_RegisterTypes(const ::std::string&) {
  ...
  const ::google::protobuf::Descriptor* ReadGroupSet_InfoEntry_descriptor = protobuf_google_2fgenomics_2fv1_2freadgroupset_2eproto::file_level_metadata[0].descriptor;
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
        ReadGroupSet_InfoEntry_descriptor,
...
const ::google::protobuf::Descriptor* ReadGroupSet::descriptor() {
  protobuf_google_2fgenomics_2fv1_2freadgroupset_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_google_2fgenomics_2fv1_2freadgroupset_2eproto::file_level_metadata[1].descriptor;
}
  ...
  for (unsigned int i = 0, n = this->read_groups_size(); i < n; i++) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageNoVirtualToArray(
        6, this->read_groups(i), false, target);
  }
...
void ReadGroupSet::InternalSwap(ReadGroupSet* other) {
  read_groups_.UnsafeArenaSwap(&other->read_groups_);
...
::google::protobuf::Metadata ReadGroupSet::GetMetadata() const {
  protobuf_google_2fgenomics_2fv1_2freadgroupset_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_google_2fgenomics_2fv1_2freadgroupset_2eproto::file_level_metadata[1];
}
