...
inline void Value::set_allocated_key_value(::google::datastore::v1::Key* key_value) {
  clear_value_type();
  if (key_value) {
    set_has_key_value();
...
inline void Value::set_allocated_entity_value(::google::datastore::v1::Entity* entity_value) {
  clear_value_type();
  if (entity_value) {
    set_has_entity_value();
...
inline void Value::set_allocated_array_value(::google::datastore::v1::ArrayValue* array_value) {
  clear_value_type();
  if (array_value) {
    set_has_array_value();
