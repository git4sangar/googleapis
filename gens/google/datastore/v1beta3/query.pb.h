...
#ifndef PROTOBUF_google_2fdatastore_2fv1beta3_2fquery_2eproto__INCLUDED
#define PROTOBUF_google_2fdatastore_2fv1beta3_2fquery_2eproto__INCLUDED
...
class EntityResult : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.datastore.v1beta3.EntityResult) */ {
 public:
  EntityResult();
  ...
  const ::google::datastore::v1beta3::Entity& entity() const;
  ::google::datastore::v1beta3::Entity* mutable_entity();
  ::google::datastore::v1beta3::Entity* release_entity();
  void set_allocated_entity(::google::datastore::v1beta3::Entity* entity);
 ...
 private:
  ...
  ::google::datastore::v1beta3::Entity* entity_;
  ::google::protobuf::int64 version_;
  mutable int _cached_size_;
  friend struct  protobuf_google_2fdatastore_2fv1beta3_2fquery_2eproto::TableStruct;
};
// -------------------------------------------------------------------

class Query : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.datastore.v1beta3.Query) */ {
 public:
  Query();
  virtual ~Query();
  ...
  const ::google::datastore::v1beta3::Projection& projection(int index) const;
  ::google::datastore::v1beta3::Projection* mutable_projection(int index);
  ::google::datastore::v1beta3::Projection* add_projection();
  ...
  const ::google::datastore::v1beta3::KindExpression& kind(int index) const;
  ::google::datastore::v1beta3::KindExpression* mutable_kind(int index);
  ::google::datastore::v1beta3::KindExpression* add_kind();
  ...
  const ::google::datastore::v1beta3::PropertyOrder& order(int index) const;
  ::google::datastore::v1beta3::PropertyOrder* mutable_order(int index);
  ::google::datastore::v1beta3::PropertyOrder* add_order();
  ...
  const ::google::datastore::v1beta3::PropertyReference& distinct_on(int index) const;
  ::google::datastore::v1beta3::PropertyReference* mutable_distinct_on(int index);
  ::google::datastore::v1beta3::PropertyReference* add_distinct_on();
  ...
  const ::google::datastore::v1beta3::Filter& filter() const;
  ::google::datastore::v1beta3::Filter* mutable_filter();
  ::google::datastore::v1beta3::Filter* release_filter();
  void set_allocated_filter(::google::datastore::v1beta3::Filter* filter);
 ...
 private:
  ...
  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  ::google::protobuf::RepeatedPtrField< ::google::datastore::v1beta3::Projection > projection_;
  ::google::protobuf::RepeatedPtrField< ::google::datastore::v1beta3::KindExpression > kind_;
  ::google::protobuf::RepeatedPtrField< ::google::datastore::v1beta3::PropertyOrder > order_;
  ::google::protobuf::RepeatedPtrField< ::google::datastore::v1beta3::PropertyReference > distinct_on_;
  ::google::protobuf::internal::ArenaStringPtr start_cursor_;
  ::google::protobuf::internal::ArenaStringPtr end_cursor_;
  ::google::datastore::v1beta3::Filter* filter_;
...
class KindExpression : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.datastore.v1beta3.KindExpression) */ {
 public:
  KindExpression();
...
class PropertyReference : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.datastore.v1beta3.PropertyReference) */ {
 public:
  PropertyReference();
...
class Projection : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.datastore.v1beta3.Projection) */ {
 public:
  Projection();
  virtual ~Projection();
  ...
  const ::google::datastore::v1beta3::PropertyReference& property() const;
  ::google::datastore::v1beta3::PropertyReference* mutable_property();
  ::google::datastore::v1beta3::PropertyReference* release_property();
  void set_allocated_property(::google::datastore::v1beta3::PropertyReference* property);

  // @@protoc_insertion_point(class_scope:google.datastore.v1beta3.Projection)
 private:

  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  ::google::datastore::v1beta3::PropertyReference* property_;
  mutable int _cached_size_;
  friend struct  protobuf_google_2fdatastore_2fv1beta3_2fquery_2eproto::TableStruct;
};
// -------------------------------------------------------------------

class PropertyOrder : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.datastore.v1beta3.PropertyOrder) */ {
 public:
  PropertyOrder();
  ...
  ::google::datastore::v1beta3::PropertyOrder_Direction direction() const;
  void set_direction(::google::datastore::v1beta3::PropertyOrder_Direction value);
...
class Filter : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.datastore.v1beta3.Filter) */ {
 public:
  Filter();
  virtual ~Filter();
  ...
  const ::google::datastore::v1beta3::CompositeFilter& composite_filter() const;
  ::google::datastore::v1beta3::CompositeFilter* mutable_composite_filter();
  ::google::datastore::v1beta3::CompositeFilter* release_composite_filter();
  void set_allocated_composite_filter(::google::datastore::v1beta3::CompositeFilter* composite_filter);
  ...
  const ::google::datastore::v1beta3::PropertyFilter& property_filter() const;
  ::google::datastore::v1beta3::PropertyFilter* mutable_property_filter();
  ::google::datastore::v1beta3::PropertyFilter* release_property_filter();
  void set_allocated_property_filter(::google::datastore::v1beta3::PropertyFilter* property_filter);
 ...
 private:
  ...
  union FilterTypeUnion {
    FilterTypeUnion() {}
    ::google::datastore::v1beta3::CompositeFilter* composite_filter_;
    ::google::datastore::v1beta3::PropertyFilter* property_filter_;
  } filter_type_;
  mutable int _cached_size_;
...
class CompositeFilter : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.datastore.v1beta3.CompositeFilter) */ {
 public:
  CompositeFilter();
  ...
  const ::google::datastore::v1beta3::Filter& filters(int index) const;
  ::google::datastore::v1beta3::Filter* mutable_filters(int index);
  ::google::datastore::v1beta3::Filter* add_filters();
  ...
  ::google::datastore::v1beta3::CompositeFilter_Operator op() const;
  void set_op(::google::datastore::v1beta3::CompositeFilter_Operator value);

  // @@protoc_insertion_point(class_scope:google.datastore.v1beta3.CompositeFilter)
 private:

  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  ::google::protobuf::RepeatedPtrField< ::google::datastore::v1beta3::Filter > filters_;
  int op_;
  mutable int _cached_size_;
  friend struct  protobuf_google_2fdatastore_2fv1beta3_2fquery_2eproto::TableStruct;
};
...
class PropertyFilter : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.datastore.v1beta3.PropertyFilter) */ {
 public:
  PropertyFilter();
  ...
  const ::google::datastore::v1beta3::Value& value() const;
  ::google::datastore::v1beta3::Value* mutable_value();
  ::google::datastore::v1beta3::Value* release_value();
  void set_allocated_value(::google::datastore::v1beta3::Value* value);

  // .google.datastore.v1beta3.PropertyFilter.Operator op = 2;
  void clear_op();
  static const int kOpFieldNumber = 2;
  ::google::datastore::v1beta3::PropertyFilter_Operator op() const;
  void set_op(::google::datastore::v1beta3::PropertyFilter_Operator value);
 ...
 private:
  ...
  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  ::google::datastore::v1beta3::PropertyReference* property_;
  ::google::datastore::v1beta3::Value* value_;
  int op_;
  mutable int _cached_size_;
  friend struct  protobuf_google_2fdatastore_2fv1beta3_2fquery_2eproto::TableStruct;
};
...
class GqlQuery : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.datastore.v1beta3.GqlQuery) */ {
 public:
  GqlQuery();
  virtual ~GqlQuery();
  ...
  const ::google::datastore::v1beta3::GqlQueryParameter& positional_bindings(int index) const;
  ::google::datastore::v1beta3::GqlQueryParameter* mutable_positional_bindings(int index);
  ::google::datastore::v1beta3::GqlQueryParameter* add_positional_bindings();
 ...
 private:
  ...
  ::google::protobuf::internal::MapField<
      ...
      ::google::protobuf::internal::WireFormatLite::TYPE_MESSAGE,
      0 > named_bindings_;
  ::google::protobuf::RepeatedPtrField< ::google::datastore::v1beta3::GqlQueryParameter > positional_bindings_;
...
class GqlQueryParameter : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.datastore.v1beta3.GqlQueryParameter) */ {
 public:
  GqlQueryParameter();
...
class QueryResultBatch : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.datastore.v1beta3.QueryResultBatch) */ {
 public:
  QueryResultBatch();
  ...
  const ::google::datastore::v1beta3::EntityResult& entity_results(int index) const;
  ::google::datastore::v1beta3::EntityResult* mutable_entity_results(int index);
  ::google::datastore::v1beta3::EntityResult* add_entity_results();
  ...
  ::google::datastore::v1beta3::EntityResult_ResultType entity_result_type() const;
  void set_entity_result_type(::google::datastore::v1beta3::EntityResult_ResultType value);
  ...
  ::google::datastore::v1beta3::QueryResultBatch_MoreResultsType more_results() const;
  void set_more_results(::google::datastore::v1beta3::QueryResultBatch_MoreResultsType value);

  // @@protoc_insertion_point(class_scope:google.datastore.v1beta3.QueryResultBatch)
 private:

  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  ::google::protobuf::RepeatedPtrField< ::google::datastore::v1beta3::EntityResult > entity_results_;
...
inline const ::google::datastore::v1beta3::Entity& EntityResult::entity() const {
...
inline ::google::datastore::v1beta3::Entity* EntityResult::mutable_entity() {
...
inline ::google::datastore::v1beta3::Entity* EntityResult::release_entity() {
...
inline void EntityResult::set_allocated_entity(::google::datastore::v1beta3::Entity* entity) {
  delete entity_;
  entity_ = entity;
  if (entity) {
...
inline const ::google::datastore::v1beta3::KindExpression& Query::kind(int index) const {
  // @@protoc_insertion_point(field_get:google.datastore.v1beta3.Query.kind)
  return kind_.Get(index);
}
inline ::google::datastore::v1beta3::KindExpression* Query::mutable_kind(int index) {
  // @@protoc_insertion_point(field_mutable:google.datastore.v1beta3.Query.kind)
  return kind_.Mutable(index);
}
inline ::google::datastore::v1beta3::KindExpression* Query::add_kind() {
  // @@protoc_insertion_point(field_add:google.datastore.v1beta3.Query.kind)
  return kind_.Add();
}
inline ::google::protobuf::RepeatedPtrField< ::google::datastore::v1beta3::KindExpression >*
Query::mutable_kind() {
  // @@protoc_insertion_point(field_mutable_list:google.datastore.v1beta3.Query.kind)
  return &kind_;
}
inline const ::google::protobuf::RepeatedPtrField< ::google::datastore::v1beta3::KindExpression >&
Query::kind() const {
...
inline const ::google::datastore::v1beta3::Filter& Query::filter() const {
...
inline ::google::datastore::v1beta3::Filter* Query::mutable_filter() {
...
inline ::google::datastore::v1beta3::Filter* Query::release_filter() {
...
inline void Query::set_allocated_filter(::google::datastore::v1beta3::Filter* filter) {
  delete filter_;
  filter_ = filter;
  if (filter) {
...
inline const ::google::datastore::v1beta3::PropertyOrder& Query::order(int index) const {
  // @@protoc_insertion_point(field_get:google.datastore.v1beta3.Query.order)
  return order_.Get(index);
}
inline ::google::datastore::v1beta3::PropertyOrder* Query::mutable_order(int index) {
  // @@protoc_insertion_point(field_mutable:google.datastore.v1beta3.Query.order)
  return order_.Mutable(index);
}
inline ::google::datastore::v1beta3::PropertyOrder* Query::add_order() {
  // @@protoc_insertion_point(field_add:google.datastore.v1beta3.Query.order)
  return order_.Add();
}
inline ::google::protobuf::RepeatedPtrField< ::google::datastore::v1beta3::PropertyOrder >*
Query::mutable_order() {
  // @@protoc_insertion_point(field_mutable_list:google.datastore.v1beta3.Query.order)
  return &order_;
}
inline const ::google::protobuf::RepeatedPtrField< ::google::datastore::v1beta3::PropertyOrder >&
Query::order() const {
...
inline const ::google::datastore::v1beta3::PropertyReference& Projection::property() const {
...
inline ::google::datastore::v1beta3::PropertyReference* Projection::mutable_property() {
...
inline ::google::datastore::v1beta3::PropertyReference* Projection::release_property() {
...
inline void Projection::set_allocated_property(::google::datastore::v1beta3::PropertyReference* property) {
  delete property_;
  property_ = property;
  if (property) {
...
inline const ::google::datastore::v1beta3::PropertyReference& PropertyOrder::property() const {
  // @@protoc_insertion_point(field_get:google.datastore.v1beta3.PropertyOrder.property)
  return property_ != NULL ? *property_
                         : *::google::datastore::v1beta3::PropertyReference::internal_default_instance();
}
inline ::google::datastore::v1beta3::PropertyReference* PropertyOrder::mutable_property() {
...
inline ::google::datastore::v1beta3::PropertyReference* PropertyOrder::release_property() {
...
inline void PropertyOrder::set_allocated_property(::google::datastore::v1beta3::PropertyReference* property) {
  delete property_;
  property_ = property;
  if (property) {
...
inline ::google::datastore::v1beta3::PropertyOrder_Direction PropertyOrder::direction() const {
...
inline void PropertyOrder::set_direction(::google::datastore::v1beta3::PropertyOrder_Direction value) {
...
inline  const ::google::datastore::v1beta3::CompositeFilter& Filter::composite_filter() const {
...
inline ::google::datastore::v1beta3::CompositeFilter* Filter::mutable_composite_filter() {
  if (!has_composite_filter()) {
    clear_filter_type();
...
inline ::google::datastore::v1beta3::CompositeFilter* Filter::release_composite_filter() {
...
inline void Filter::set_allocated_composite_filter(::google::datastore::v1beta3::CompositeFilter* composite_filter) {
  clear_filter_type();
  if (composite_filter) {
    set_has_composite_filter();
...
inline  const ::google::datastore::v1beta3::PropertyFilter& Filter::property_filter() const {
...
inline ::google::datastore::v1beta3::PropertyFilter* Filter::mutable_property_filter() {
  if (!has_property_filter()) {
    clear_filter_type();
...
inline ::google::datastore::v1beta3::PropertyFilter* Filter::release_property_filter() {
...
inline void Filter::set_allocated_property_filter(::google::datastore::v1beta3::PropertyFilter* property_filter) {
  clear_filter_type();
  if (property_filter) {
    set_has_property_filter();
...
inline ::google::datastore::v1beta3::CompositeFilter_Operator CompositeFilter::op() const {
...
inline void CompositeFilter::set_op(::google::datastore::v1beta3::CompositeFilter_Operator value) {
...
inline const ::google::datastore::v1beta3::Filter& CompositeFilter::filters(int index) const {
  // @@protoc_insertion_point(field_get:google.datastore.v1beta3.CompositeFilter.filters)
  return filters_.Get(index);
}
inline ::google::datastore::v1beta3::Filter* CompositeFilter::mutable_filters(int index) {
  // @@protoc_insertion_point(field_mutable:google.datastore.v1beta3.CompositeFilter.filters)
  return filters_.Mutable(index);
}
inline ::google::datastore::v1beta3::Filter* CompositeFilter::add_filters() {
  // @@protoc_insertion_point(field_add:google.datastore.v1beta3.CompositeFilter.filters)
  return filters_.Add();
}
inline ::google::protobuf::RepeatedPtrField< ::google::datastore::v1beta3::Filter >*
...
inline const ::google::protobuf::RepeatedPtrField< ::google::datastore::v1beta3::Filter >&
...
inline const ::google::datastore::v1beta3::PropertyReference& PropertyFilter::property() const {
  // @@protoc_insertion_point(field_get:google.datastore.v1beta3.PropertyFilter.property)
  return property_ != NULL ? *property_
                         : *::google::datastore::v1beta3::PropertyReference::internal_default_instance();
}
inline ::google::datastore::v1beta3::PropertyReference* PropertyFilter::mutable_property() {
...
inline ::google::datastore::v1beta3::PropertyReference* PropertyFilter::release_property() {
...
inline void PropertyFilter::set_allocated_property(::google::datastore::v1beta3::PropertyReference* property) {
  delete property_;
  property_ = property;
  if (property) {
...
inline ::google::datastore::v1beta3::PropertyFilter_Operator PropertyFilter::op() const {
...
inline void PropertyFilter::set_op(::google::datastore::v1beta3::PropertyFilter_Operator value) {
...
inline const ::google::datastore::v1beta3::Value& PropertyFilter::value() const {
...
inline ::google::datastore::v1beta3::Value* PropertyFilter::mutable_value() {
...
inline ::google::datastore::v1beta3::Value* PropertyFilter::release_value() {
...
inline void PropertyFilter::set_allocated_value(::google::datastore::v1beta3::Value* value) {
  delete value_;
  value_ = value;
  if (value) {
...
inline const ::google::protobuf::Map< ::std::string, ::google::datastore::v1beta3::GqlQueryParameter >&
...
inline ::google::protobuf::Map< ::std::string, ::google::datastore::v1beta3::GqlQueryParameter >*
...
inline const ::google::datastore::v1beta3::GqlQueryParameter& GqlQuery::positional_bindings(int index) const {
...
inline ::google::datastore::v1beta3::GqlQueryParameter* GqlQuery::mutable_positional_bindings(int index) {
...
inline ::google::datastore::v1beta3::GqlQueryParameter* GqlQuery::add_positional_bindings() {
  // @@protoc_insertion_point(field_add:google.datastore.v1beta3.GqlQuery.positional_bindings)
  return positional_bindings_.Add();
}
inline ::google::protobuf::RepeatedPtrField< ::google::datastore::v1beta3::GqlQueryParameter >*
...
inline const ::google::protobuf::RepeatedPtrField< ::google::datastore::v1beta3::GqlQueryParameter >&
...
inline  const ::google::datastore::v1beta3::Value& GqlQueryParameter::value() const {
...
inline ::google::datastore::v1beta3::Value* GqlQueryParameter::mutable_value() {
  if (!has_value()) {
...
inline ::google::datastore::v1beta3::Value* GqlQueryParameter::release_value() {
...
inline void GqlQueryParameter::set_allocated_value(::google::datastore::v1beta3::Value* value) {
  clear_parameter_type();
  if (value) {
    set_has_value();
...
inline ::google::datastore::v1beta3::EntityResult_ResultType QueryResultBatch::entity_result_type() const {
...
inline void QueryResultBatch::set_entity_result_type(::google::datastore::v1beta3::EntityResult_ResultType value) {
...
inline const ::google::datastore::v1beta3::EntityResult& QueryResultBatch::entity_results(int index) const {
...
inline ::google::datastore::v1beta3::EntityResult* QueryResultBatch::mutable_entity_results(int index) {
...
inline ::google::datastore::v1beta3::EntityResult* QueryResultBatch::add_entity_results() {
...
inline ::google::datastore::v1beta3::QueryResultBatch_MoreResultsType QueryResultBatch::more_results() const {
...
inline void QueryResultBatch::set_more_results(::google::datastore::v1beta3::QueryResultBatch_MoreResultsType value) {
...
template <> struct is_proto_enum< ::google::datastore::v1beta3::EntityResult_ResultType> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::google::datastore::v1beta3::EntityResult_ResultType>() {
  return ::google::datastore::v1beta3::EntityResult_ResultType_descriptor();
}
template <> struct is_proto_enum< ::google::datastore::v1beta3::PropertyOrder_Direction> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::google::datastore::v1beta3::PropertyOrder_Direction>() {
  return ::google::datastore::v1beta3::PropertyOrder_Direction_descriptor();
}
template <> struct is_proto_enum< ::google::datastore::v1beta3::CompositeFilter_Operator> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::google::datastore::v1beta3::CompositeFilter_Operator>() {
  return ::google::datastore::v1beta3::CompositeFilter_Operator_descriptor();
}
template <> struct is_proto_enum< ::google::datastore::v1beta3::PropertyFilter_Operator> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::google::datastore::v1beta3::PropertyFilter_Operator>() {
  return ::google::datastore::v1beta3::PropertyFilter_Operator_descriptor();
}
template <> struct is_proto_enum< ::google::datastore::v1beta3::QueryResultBatch_MoreResultsType> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::google::datastore::v1beta3::QueryResultBatch_MoreResultsType>() {
  return ::google::datastore::v1beta3::QueryResultBatch_MoreResultsType_descriptor();
}
...
#endif  // PROTOBUF_google_2fdatastore_2fv1beta3_2fquery_2eproto__INCLUDED
