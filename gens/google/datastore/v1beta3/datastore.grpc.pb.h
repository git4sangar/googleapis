...
//
#ifndef GRPC_google_2fdatastore_2fv1beta3_2fdatastore_2eproto__INCLUDED
#define GRPC_google_2fdatastore_2fv1beta3_2fdatastore_2eproto__INCLUDED
 ...
 public:
  class StubInterface {
   public:
    ...
    virtual ::grpc::Status Lookup(::grpc::ClientContext* context, const ::google::datastore::v1beta3::LookupRequest& request, ::google::datastore::v1beta3::LookupResponse* response) = 0;
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::google::datastore::v1beta3::LookupResponse>> AsyncLookup(::grpc::ClientContext* context, const ::google::datastore::v1beta3::LookupRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::google::datastore::v1beta3::LookupResponse>>(AsyncLookupRaw(context, request, cq));
    }
    // Queries for entities.
    virtual ::grpc::Status RunQuery(::grpc::ClientContext* context, const ::google::datastore::v1beta3::RunQueryRequest& request, ::google::datastore::v1beta3::RunQueryResponse* response) = 0;
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::google::datastore::v1beta3::RunQueryResponse>> AsyncRunQuery(::grpc::ClientContext* context, const ::google::datastore::v1beta3::RunQueryRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::google::datastore::v1beta3::RunQueryResponse>>(AsyncRunQueryRaw(context, request, cq));
    }
    // Begins a new transaction.
    virtual ::grpc::Status BeginTransaction(::grpc::ClientContext* context, const ::google::datastore::v1beta3::BeginTransactionRequest& request, ::google::datastore::v1beta3::BeginTransactionResponse* response) = 0;
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::google::datastore::v1beta3::BeginTransactionResponse>> AsyncBeginTransaction(::grpc::ClientContext* context, const ::google::datastore::v1beta3::BeginTransactionRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::google::datastore::v1beta3::BeginTransactionResponse>>(AsyncBeginTransactionRaw(context, request, cq));
    }
    // Commits a transaction, optionally creating, deleting or modifying some
    // entities.
    virtual ::grpc::Status Commit(::grpc::ClientContext* context, const ::google::datastore::v1beta3::CommitRequest& request, ::google::datastore::v1beta3::CommitResponse* response) = 0;
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::google::datastore::v1beta3::CommitResponse>> AsyncCommit(::grpc::ClientContext* context, const ::google::datastore::v1beta3::CommitRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::google::datastore::v1beta3::CommitResponse>>(AsyncCommitRaw(context, request, cq));
    }
    // Rolls back a transaction.
    virtual ::grpc::Status Rollback(::grpc::ClientContext* context, const ::google::datastore::v1beta3::RollbackRequest& request, ::google::datastore::v1beta3::RollbackResponse* response) = 0;
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::google::datastore::v1beta3::RollbackResponse>> AsyncRollback(::grpc::ClientContext* context, const ::google::datastore::v1beta3::RollbackRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::google::datastore::v1beta3::RollbackResponse>>(AsyncRollbackRaw(context, request, cq));
    }
    // Allocates IDs for the given keys, which is useful for referencing an entity
    // before it is inserted.
    virtual ::grpc::Status AllocateIds(::grpc::ClientContext* context, const ::google::datastore::v1beta3::AllocateIdsRequest& request, ::google::datastore::v1beta3::AllocateIdsResponse* response) = 0;
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::google::datastore::v1beta3::AllocateIdsResponse>> AsyncAllocateIds(::grpc::ClientContext* context, const ::google::datastore::v1beta3::AllocateIdsRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::google::datastore::v1beta3::AllocateIdsResponse>>(AsyncAllocateIdsRaw(context, request, cq));
    }
  private:
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::google::datastore::v1beta3::LookupResponse>* AsyncLookupRaw(::grpc::ClientContext* context, const ::google::datastore::v1beta3::LookupRequest& request, ::grpc::CompletionQueue* cq) = 0;
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::google::datastore::v1beta3::RunQueryResponse>* AsyncRunQueryRaw(::grpc::ClientContext* context, const ::google::datastore::v1beta3::RunQueryRequest& request, ::grpc::CompletionQueue* cq) = 0;
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::google::datastore::v1beta3::BeginTransactionResponse>* AsyncBeginTransactionRaw(::grpc::ClientContext* context, const ::google::datastore::v1beta3::BeginTransactionRequest& request, ::grpc::CompletionQueue* cq) = 0;
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::google::datastore::v1beta3::CommitResponse>* AsyncCommitRaw(::grpc::ClientContext* context, const ::google::datastore::v1beta3::CommitRequest& request, ::grpc::CompletionQueue* cq) = 0;
  ...
  class Stub final : public StubInterface {
   ...
   private:
    ...
    const ::grpc::RpcMethod rpcmethod_Rollback_;
    const ::grpc::RpcMethod rpcmethod_AllocateIds_;
  };
  ...
  class Service : public ::grpc::Service {
   public:
    ...
    virtual ~Service();
    // Looks up entities by key.
    virtual ::grpc::Status Lookup(::grpc::ServerContext* context, const ::google::datastore::v1beta3::LookupRequest* request, ::google::datastore::v1beta3::LookupResponse* response);
    // Queries for entities.
    virtual ::grpc::Status RunQuery(::grpc::ServerContext* context, const ::google::datastore::v1beta3::RunQueryRequest* request, ::google::datastore::v1beta3::RunQueryResponse* response);
    // Begins a new transaction.
    virtual ::grpc::Status BeginTransaction(::grpc::ServerContext* context, const ::google::datastore::v1beta3::BeginTransactionRequest* request, ::google::datastore::v1beta3::BeginTransactionResponse* response);
    // Commits a transaction, optionally creating, deleting or modifying some
    // entities.
    virtual ::grpc::Status Commit(::grpc::ServerContext* context, const ::google::datastore::v1beta3::CommitRequest* request, ::google::datastore::v1beta3::CommitResponse* response);
    // Rolls back a transaction.
    virtual ::grpc::Status Rollback(::grpc::ServerContext* context, const ::google::datastore::v1beta3::RollbackRequest* request, ::google::datastore::v1beta3::RollbackResponse* response);
    // Allocates IDs for the given keys, which is useful for referencing an entity
    // before it is inserted.
    virtual ::grpc::Status AllocateIds(::grpc::ServerContext* context, const ::google::datastore::v1beta3::AllocateIdsRequest* request, ::google::datastore::v1beta3::AllocateIdsResponse* response);
  };
  ...
  class WithAsyncMethod_Lookup : public BaseClass {
   ...
   public:
    ...
    void RequestLookup(::grpc::ServerContext* context, ::google::datastore::v1beta3::LookupRequest* request, ::grpc::ServerAsyncResponseWriter< ::google::datastore::v1beta3::LookupResponse>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
  ...
  class WithAsyncMethod_RunQuery : public BaseClass {
   ...
   public:
    ...
    void RequestRunQuery(::grpc::ServerContext* context, ::google::datastore::v1beta3::RunQueryRequest* request, ::grpc::ServerAsyncResponseWriter< ::google::datastore::v1beta3::RunQueryResponse>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
  ...
  class WithAsyncMethod_BeginTransaction : public BaseClass {
   ...
   public:
    ...
    void RequestBeginTransaction(::grpc::ServerContext* context, ::google::datastore::v1beta3::BeginTransactionRequest* request, ::grpc::ServerAsyncResponseWriter< ::google::datastore::v1beta3::BeginTransactionResponse>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
  ...
  class WithAsyncMethod_Commit : public BaseClass {
   ...
   public:
    ...
    void RequestCommit(::grpc::ServerContext* context, ::google::datastore::v1beta3::CommitRequest* request, ::grpc::ServerAsyncResponseWriter< ::google::datastore::v1beta3::CommitResponse>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
  ...
  class WithAsyncMethod_Rollback : public BaseClass {
   ...
   public:
    ...
    void RequestRollback(::grpc::ServerContext* context, ::google::datastore::v1beta3::RollbackRequest* request, ::grpc::ServerAsyncResponseWriter< ::google::datastore::v1beta3::RollbackResponse>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
  ...
  class WithAsyncMethod_AllocateIds : public BaseClass {
   ...
   public:
    ...
    void RequestAllocateIds(::grpc::ServerContext* context, ::google::datastore::v1beta3::AllocateIdsRequest* request, ::grpc::ServerAsyncResponseWriter< ::google::datastore::v1beta3::AllocateIdsResponse>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
...
#endif  // GRPC_google_2fdatastore_2fv1beta3_2fdatastore_2eproto__INCLUDED
