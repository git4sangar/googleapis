...
inline void RunQueryRequest::set_allocated_query(::google::datastore::v1beta3::Query* query) {
  clear_query_type();
  if (query) {
    set_has_query();
...
inline void RunQueryRequest::set_allocated_gql_query(::google::datastore::v1beta3::GqlQuery* gql_query) {
  clear_query_type();
  if (gql_query) {
    set_has_gql_query();
...
inline void Mutation::set_allocated_insert(::google::datastore::v1beta3::Entity* insert) {
  clear_operation();
  if (insert) {
    set_has_insert();
...
inline void Mutation::set_allocated_update(::google::datastore::v1beta3::Entity* update) {
  clear_operation();
  if (update) {
    set_has_update();
...
inline void Mutation::set_allocated_upsert(::google::datastore::v1beta3::Entity* upsert) {
  clear_operation();
  if (upsert) {
    set_has_upsert();
...
inline void Mutation::set_allocated_delete_(::google::datastore::v1beta3::Key* delete_) {
  clear_operation();
  if (delete_) {
    set_has_delete_();
