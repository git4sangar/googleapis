...
ByteStream::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel)
  : channel_(channel), rpcmethod_Read_(ByteStream_method_names[0], ::grpc::RpcMethod::SERVER_STREAMING, channel)
  , rpcmethod_Write_(ByteStream_method_names[1], ::grpc::RpcMethod::CLIENT_STREAMING, channel)
  , rpcmethod_QueryWriteStatus_(ByteStream_method_names[2], ::grpc::RpcMethod::NORMAL_RPC, channel)
  {}
...
::grpc::ClientReader< ::google::bytestream::ReadResponse>* ByteStream::Stub::ReadRaw(::grpc::ClientContext* context, const ::google::bytestream::ReadRequest& request) {
  return new ::grpc::ClientReader< ::google::bytestream::ReadResponse>(channel_.get(), rpcmethod_Read_, context, request);
}
...
::grpc::ClientAsyncReader< ::google::bytestream::ReadResponse>* ByteStream::Stub::AsyncReadRaw(::grpc::ClientContext* context, const ::google::bytestream::ReadRequest& request, ::grpc::CompletionQueue* cq, void* tag) {
  return new ::grpc::ClientAsyncReader< ::google::bytestream::ReadResponse>(channel_.get(), cq, rpcmethod_Read_, context, request, tag);
}
...
::grpc::ClientWriter< ::google::bytestream::WriteRequest>* ByteStream::Stub::WriteRaw(::grpc::ClientContext* context, ::google::bytestream::WriteResponse* response) {
  return new ::grpc::ClientWriter< ::google::bytestream::WriteRequest>(channel_.get(), rpcmethod_Write_, context, response);
}
...
::grpc::ClientAsyncWriter< ::google::bytestream::WriteRequest>* ByteStream::Stub::AsyncWriteRaw(::grpc::ClientContext* context, ::google::bytestream::WriteResponse* response, ::grpc::CompletionQueue* cq, void* tag) {
  return new ::grpc::ClientAsyncWriter< ::google::bytestream::WriteRequest>(channel_.get(), cq, rpcmethod_Write_, context, response, tag);
}
...
::grpc::Status ByteStream::Stub::QueryWriteStatus(::grpc::ClientContext* context, const ::google::bytestream::QueryWriteStatusRequest& request, ::google::bytestream::QueryWriteStatusResponse* response) {
  return ::grpc::BlockingUnaryCall(channel_.get(), rpcmethod_QueryWriteStatus_, context, request, response);
}
...
::grpc::ClientAsyncResponseReader< ::google::bytestream::QueryWriteStatusResponse>* ByteStream::Stub::AsyncQueryWriteStatusRaw(::grpc::ClientContext* context, const ::google::bytestream::QueryWriteStatusRequest& request, ::grpc::CompletionQueue* cq) {
  return new ::grpc::ClientAsyncResponseReader< ::google::bytestream::QueryWriteStatusResponse>(channel_.get(), cq, rpcmethod_QueryWriteStatus_, context, request);
}
...
ByteStream::Service::Service() {
  AddMethod(new ::grpc::RpcServiceMethod(
      ...
      new ::grpc::ServerStreamingHandler< ByteStream::Service, ::google::bytestream::ReadRequest, ::google::bytestream::ReadResponse>(
          std::mem_fn(&ByteStream::Service::Read), this)));
  AddMethod(new ::grpc::RpcServiceMethod(
      ByteStream_method_names[1],
      ::grpc::RpcMethod::CLIENT_STREAMING,
      new ::grpc::ClientStreamingHandler< ByteStream::Service, ::google::bytestream::WriteRequest, ::google::bytestream::WriteResponse>(
          std::mem_fn(&ByteStream::Service::Write), this)));
  AddMethod(new ::grpc::RpcServiceMethod(
      ByteStream_method_names[2],
      ::grpc::RpcMethod::NORMAL_RPC,
      new ::grpc::RpcMethodHandler< ByteStream::Service, ::google::bytestream::QueryWriteStatusRequest, ::google::bytestream::QueryWriteStatusResponse>(
