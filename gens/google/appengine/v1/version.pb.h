...
inline void Version::set_allocated_automatic_scaling(::google::appengine::v1::AutomaticScaling* automatic_scaling) {
  clear_scaling();
...
inline void Version::set_allocated_basic_scaling(::google::appengine::v1::BasicScaling* basic_scaling) {
  clear_scaling();
  if (basic_scaling) {
    set_has_basic_scaling();
...
inline void Version::set_allocated_manual_scaling(::google::appengine::v1::ManualScaling* manual_scaling) {
  clear_scaling();
  if (manual_scaling) {
    set_has_manual_scaling();
...
inline void Version::clear_handlers() {
  handlers_.Clear();
}
...
inline void Version::clear_error_handlers() {
...
inline void Version::clear_libraries() {
  libraries_.Clear();
}
...
inline void Version::clear_api_config() {
...
inline void Version::clear_default_expiration() {
...
inline void Version::clear_health_check() {
...
inline void Version::clear_deployment() {
...
inline void AutomaticScaling::clear_cool_down_period() {
...
inline void AutomaticScaling::clear_max_pending_latency() {
...
inline void AutomaticScaling::clear_min_pending_latency() {
...
inline void BasicScaling::clear_idle_timeout() {
...
inline void CpuUtilization::clear_aggregation_window_length() {
