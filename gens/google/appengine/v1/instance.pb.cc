...
Instance::Instance()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    protobuf_google_2fappengine_2fv1_2finstance_2eproto::InitDefaults();
  }
  SharedCtor();
...
const ::google::protobuf::Descriptor* Instance::descriptor() {
  protobuf_google_2fappengine_2fv1_2finstance_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_google_2fappengine_2fv1_2finstance_2eproto::file_level_metadata[0].descriptor;
}
...
::google::protobuf::Metadata Instance::GetMetadata() const {
  protobuf_google_2fappengine_2fv1_2finstance_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_google_2fappengine_2fv1_2finstance_2eproto::file_level_metadata[0];
}
...
#if LANG_CXX11
void Instance::set_id(::std::string&& value) {
...
#if LANG_CXX11
void Instance::set_app_engine_release(::std::string&& value) {
...
#if LANG_CXX11
void Instance::set_vm_name(::std::string&& value) {
...
#if LANG_CXX11
void Instance::set_vm_zone_name(::std::string&& value) {
...
#if LANG_CXX11
void Instance::set_vm_id(::std::string&& value) {
...
#if LANG_CXX11
void Instance::set_vm_status(::std::string&& value) {
