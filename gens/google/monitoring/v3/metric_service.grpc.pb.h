 ...
 public:
  ...
  class Stub final : public StubInterface {
   ...
   private:
    ...
    const ::grpc::RpcMethod rpcmethod_GetMetricDescriptor_;
    const ::grpc::RpcMethod rpcmethod_CreateMetricDescriptor_;
    const ::grpc::RpcMethod rpcmethod_DeleteMetricDescriptor_;
    const ::grpc::RpcMethod rpcmethod_ListTimeSeries_;
    const ::grpc::RpcMethod rpcmethod_CreateTimeSeries_;
  };
