...
inline void ExecuteSqlRequest::clear_transaction() {
...
inline void ExecuteSqlRequest::clear_params() {
...
inline void ExecuteSqlRequest::clear_param_types() {
  param_types_.Clear();
}
...
inline void ReadRequest::clear_transaction() {
  if (GetArenaNoVirtual() == NULL && transaction_ != NULL) delete transaction_;
  transaction_ = NULL;
}
...
inline void ReadRequest::clear_key_set() {
...
inline void BeginTransactionRequest::clear_options() {
...
inline void CommitRequest::clear_single_use_transaction() {
...
inline void CommitRequest::set_allocated_single_use_transaction(::google::spanner::v1::TransactionOptions* single_use_transaction) {
  clear_transaction();
...
inline void CommitResponse::clear_commit_timestamp() {
