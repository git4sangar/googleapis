...
Spanner::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel)
  : channel_(channel), rpcmethod_CreateSession_(Spanner_method_names[0], ::grpc::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_GetSession_(Spanner_method_names[1], ::grpc::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_DeleteSession_(Spanner_method_names[2], ::grpc::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_ExecuteSql_(Spanner_method_names[3], ::grpc::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_ExecuteStreamingSql_(Spanner_method_names[4], ::grpc::RpcMethod::SERVER_STREAMING, channel)
  , rpcmethod_Read_(Spanner_method_names[5], ::grpc::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_StreamingRead_(Spanner_method_names[6], ::grpc::RpcMethod::SERVER_STREAMING, channel)
  , rpcmethod_BeginTransaction_(Spanner_method_names[7], ::grpc::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_Commit_(Spanner_method_names[8], ::grpc::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_Rollback_(Spanner_method_names[9], ::grpc::RpcMethod::NORMAL_RPC, channel)
  {}
...
::grpc::ClientAsyncResponseReader< ::google::spanner::v1::Session>* Spanner::Stub::AsyncCreateSessionRaw(::grpc::ClientContext* context, const ::google::spanner::v1::CreateSessionRequest& request, ::grpc::CompletionQueue* cq) {
  return new ::grpc::ClientAsyncResponseReader< ::google::spanner::v1::Session>(channel_.get(), cq, rpcmethod_CreateSession_, context, request);
}
...
::grpc::ClientAsyncResponseReader< ::google::spanner::v1::Session>* Spanner::Stub::AsyncGetSessionRaw(::grpc::ClientContext* context, const ::google::spanner::v1::GetSessionRequest& request, ::grpc::CompletionQueue* cq) {
  return new ::grpc::ClientAsyncResponseReader< ::google::spanner::v1::Session>(channel_.get(), cq, rpcmethod_GetSession_, context, request);
}
...
::grpc::ClientAsyncResponseReader< ::google::protobuf::Empty>* Spanner::Stub::AsyncDeleteSessionRaw(::grpc::ClientContext* context, const ::google::spanner::v1::DeleteSessionRequest& request, ::grpc::CompletionQueue* cq) {
  return new ::grpc::ClientAsyncResponseReader< ::google::protobuf::Empty>(channel_.get(), cq, rpcmethod_DeleteSession_, context, request);
}
...
::grpc::Status Spanner::Stub::ExecuteSql(::grpc::ClientContext* context, const ::google::spanner::v1::ExecuteSqlRequest& request, ::google::spanner::v1::ResultSet* response) {
  return ::grpc::BlockingUnaryCall(channel_.get(), rpcmethod_ExecuteSql_, context, request, response);
}
...
::grpc::ClientAsyncResponseReader< ::google::spanner::v1::ResultSet>* Spanner::Stub::AsyncExecuteSqlRaw(::grpc::ClientContext* context, const ::google::spanner::v1::ExecuteSqlRequest& request, ::grpc::CompletionQueue* cq) {
  return new ::grpc::ClientAsyncResponseReader< ::google::spanner::v1::ResultSet>(channel_.get(), cq, rpcmethod_ExecuteSql_, context, request);
}
...
::grpc::ClientReader< ::google::spanner::v1::PartialResultSet>* Spanner::Stub::ExecuteStreamingSqlRaw(::grpc::ClientContext* context, const ::google::spanner::v1::ExecuteSqlRequest& request) {
  return new ::grpc::ClientReader< ::google::spanner::v1::PartialResultSet>(channel_.get(), rpcmethod_ExecuteStreamingSql_, context, request);
}
...
::grpc::ClientAsyncReader< ::google::spanner::v1::PartialResultSet>* Spanner::Stub::AsyncExecuteStreamingSqlRaw(::grpc::ClientContext* context, const ::google::spanner::v1::ExecuteSqlRequest& request, ::grpc::CompletionQueue* cq, void* tag) {
  return new ::grpc::ClientAsyncReader< ::google::spanner::v1::PartialResultSet>(channel_.get(), cq, rpcmethod_ExecuteStreamingSql_, context, request, tag);
}
...
::grpc::ClientAsyncResponseReader< ::google::spanner::v1::ResultSet>* Spanner::Stub::AsyncReadRaw(::grpc::ClientContext* context, const ::google::spanner::v1::ReadRequest& request, ::grpc::CompletionQueue* cq) {
  return new ::grpc::ClientAsyncResponseReader< ::google::spanner::v1::ResultSet>(channel_.get(), cq, rpcmethod_Read_, context, request);
}
...
::grpc::ClientReader< ::google::spanner::v1::PartialResultSet>* Spanner::Stub::StreamingReadRaw(::grpc::ClientContext* context, const ::google::spanner::v1::ReadRequest& request) {
  return new ::grpc::ClientReader< ::google::spanner::v1::PartialResultSet>(channel_.get(), rpcmethod_StreamingRead_, context, request);
}
...
::grpc::ClientAsyncReader< ::google::spanner::v1::PartialResultSet>* Spanner::Stub::AsyncStreamingReadRaw(::grpc::ClientContext* context, const ::google::spanner::v1::ReadRequest& request, ::grpc::CompletionQueue* cq, void* tag) {
  return new ::grpc::ClientAsyncReader< ::google::spanner::v1::PartialResultSet>(channel_.get(), cq, rpcmethod_StreamingRead_, context, request, tag);
}
...
::grpc::ClientAsyncResponseReader< ::google::spanner::v1::Transaction>* Spanner::Stub::AsyncBeginTransactionRaw(::grpc::ClientContext* context, const ::google::spanner::v1::BeginTransactionRequest& request, ::grpc::CompletionQueue* cq) {
  return new ::grpc::ClientAsyncResponseReader< ::google::spanner::v1::Transaction>(channel_.get(), cq, rpcmethod_BeginTransaction_, context, request);
}
...
::grpc::ClientAsyncResponseReader< ::google::spanner::v1::CommitResponse>* Spanner::Stub::AsyncCommitRaw(::grpc::ClientContext* context, const ::google::spanner::v1::CommitRequest& request, ::grpc::CompletionQueue* cq) {
  return new ::grpc::ClientAsyncResponseReader< ::google::spanner::v1::CommitResponse>(channel_.get(), cq, rpcmethod_Commit_, context, request);
}
...
::grpc::ClientAsyncResponseReader< ::google::protobuf::Empty>* Spanner::Stub::AsyncRollbackRaw(::grpc::ClientContext* context, const ::google::spanner::v1::RollbackRequest& request, ::grpc::CompletionQueue* cq) {
  return new ::grpc::ClientAsyncResponseReader< ::google::protobuf::Empty>(channel_.get(), cq, rpcmethod_Rollback_, context, request);
}
...
Spanner::Service::Service() {
  AddMethod(new ::grpc::RpcServiceMethod(
      ...
      new ::grpc::RpcMethodHandler< Spanner::Service, ::google::spanner::v1::CreateSessionRequest, ::google::spanner::v1::Session>(
          std::mem_fn(&Spanner::Service::CreateSession), this)));
  AddMethod(new ::grpc::RpcServiceMethod(
      Spanner_method_names[1],
      ::grpc::RpcMethod::NORMAL_RPC,
      new ::grpc::RpcMethodHandler< Spanner::Service, ::google::spanner::v1::GetSessionRequest, ::google::spanner::v1::Session>(
          std::mem_fn(&Spanner::Service::GetSession), this)));
  AddMethod(new ::grpc::RpcServiceMethod(
      Spanner_method_names[2],
      ::grpc::RpcMethod::NORMAL_RPC,
      new ::grpc::RpcMethodHandler< Spanner::Service, ::google::spanner::v1::DeleteSessionRequest, ::google::protobuf::Empty>(
          std::mem_fn(&Spanner::Service::DeleteSession), this)));
  AddMethod(new ::grpc::RpcServiceMethod(
      Spanner_method_names[3],
      ::grpc::RpcMethod::NORMAL_RPC,
      new ::grpc::RpcMethodHandler< Spanner::Service, ::google::spanner::v1::ExecuteSqlRequest, ::google::spanner::v1::ResultSet>(
          std::mem_fn(&Spanner::Service::ExecuteSql), this)));
  AddMethod(new ::grpc::RpcServiceMethod(
      Spanner_method_names[4],
      ::grpc::RpcMethod::SERVER_STREAMING,
      new ::grpc::ServerStreamingHandler< Spanner::Service, ::google::spanner::v1::ExecuteSqlRequest, ::google::spanner::v1::PartialResultSet>(
          std::mem_fn(&Spanner::Service::ExecuteStreamingSql), this)));
  AddMethod(new ::grpc::RpcServiceMethod(
      Spanner_method_names[5],
      ::grpc::RpcMethod::NORMAL_RPC,
      new ::grpc::RpcMethodHandler< Spanner::Service, ::google::spanner::v1::ReadRequest, ::google::spanner::v1::ResultSet>(
          std::mem_fn(&Spanner::Service::Read), this)));
  AddMethod(new ::grpc::RpcServiceMethod(
      Spanner_method_names[6],
      ::grpc::RpcMethod::SERVER_STREAMING,
      new ::grpc::ServerStreamingHandler< Spanner::Service, ::google::spanner::v1::ReadRequest, ::google::spanner::v1::PartialResultSet>(
          std::mem_fn(&Spanner::Service::StreamingRead), this)));
  AddMethod(new ::grpc::RpcServiceMethod(
      Spanner_method_names[7],
      ::grpc::RpcMethod::NORMAL_RPC,
      new ::grpc::RpcMethodHandler< Spanner::Service, ::google::spanner::v1::BeginTransactionRequest, ::google::spanner::v1::Transaction>(
          std::mem_fn(&Spanner::Service::BeginTransaction), this)));
  AddMethod(new ::grpc::RpcServiceMethod(
      Spanner_method_names[8],
      ::grpc::RpcMethod::NORMAL_RPC,
      new ::grpc::RpcMethodHandler< Spanner::Service, ::google::spanner::v1::CommitRequest, ::google::spanner::v1::CommitResponse>(
          std::mem_fn(&Spanner::Service::Commit), this)));
  AddMethod(new ::grpc::RpcServiceMethod(
      Spanner_method_names[9],
      ::grpc::RpcMethod::NORMAL_RPC,
      new ::grpc::RpcMethodHandler< Spanner::Service, ::google::spanner::v1::RollbackRequest, ::google::protobuf::Empty>(
