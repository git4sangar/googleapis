 ...
 public:
  ...
  class Stub final : public StubInterface {
   ...
   private:
    ...
    const ::grpc::RpcMethod rpcmethod_ListDatabases_;
    const ::grpc::RpcMethod rpcmethod_CreateDatabase_;
    const ::grpc::RpcMethod rpcmethod_GetDatabase_;
    const ::grpc::RpcMethod rpcmethod_UpdateDatabaseDdl_;
    const ::grpc::RpcMethod rpcmethod_DropDatabase_;
    const ::grpc::RpcMethod rpcmethod_GetDatabaseDdl_;
   ...
   public:
    WithStreamedUnaryMethod_ListDatabases() {
      ::grpc::Service::MarkMethodStreamed(0,
        new ::grpc::StreamedUnaryHandler< ::google::spanner::admin::database::v1::ListDatabasesRequest, ::google::spanner::admin::database::v1::ListDatabasesResponse>(std::bind(&WithStreamedUnaryMethod_ListDatabases<BaseClass>::StreamedListDatabases, this, std::placeholders::_1, std::placeholders::_2)));
    }
   ...
   public:
    WithStreamedUnaryMethod_CreateDatabase() {
      ::grpc::Service::MarkMethodStreamed(1,
        new ::grpc::StreamedUnaryHandler< ::google::spanner::admin::database::v1::CreateDatabaseRequest, ::google::longrunning::Operation>(std::bind(&WithStreamedUnaryMethod_CreateDatabase<BaseClass>::StreamedCreateDatabase, this, std::placeholders::_1, std::placeholders::_2)));
    }
   ...
   public:
    WithStreamedUnaryMethod_GetDatabase() {
      ::grpc::Service::MarkMethodStreamed(2,
        new ::grpc::StreamedUnaryHandler< ::google::spanner::admin::database::v1::GetDatabaseRequest, ::google::spanner::admin::database::v1::Database>(std::bind(&WithStreamedUnaryMethod_GetDatabase<BaseClass>::StreamedGetDatabase, this, std::placeholders::_1, std::placeholders::_2)));
    }
   ...
   public:
    WithStreamedUnaryMethod_UpdateDatabaseDdl() {
      ::grpc::Service::MarkMethodStreamed(3,
        new ::grpc::StreamedUnaryHandler< ::google::spanner::admin::database::v1::UpdateDatabaseDdlRequest, ::google::longrunning::Operation>(std::bind(&WithStreamedUnaryMethod_UpdateDatabaseDdl<BaseClass>::StreamedUpdateDatabaseDdl, this, std::placeholders::_1, std::placeholders::_2)));
    }
   ...
   public:
    WithStreamedUnaryMethod_DropDatabase() {
      ::grpc::Service::MarkMethodStreamed(4,
        new ::grpc::StreamedUnaryHandler< ::google::spanner::admin::database::v1::DropDatabaseRequest, ::google::protobuf::Empty>(std::bind(&WithStreamedUnaryMethod_DropDatabase<BaseClass>::StreamedDropDatabase, this, std::placeholders::_1, std::placeholders::_2)));
    }
   ...
   public:
    WithStreamedUnaryMethod_GetDatabaseDdl() {
      ::grpc::Service::MarkMethodStreamed(5,
        new ::grpc::StreamedUnaryHandler< ::google::spanner::admin::database::v1::GetDatabaseDdlRequest, ::google::spanner::admin::database::v1::GetDatabaseDdlResponse>(std::bind(&WithStreamedUnaryMethod_GetDatabaseDdl<BaseClass>::StreamedGetDatabaseDdl, this, std::placeholders::_1, std::placeholders::_2)));
    }
