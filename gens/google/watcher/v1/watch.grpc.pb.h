   ...
   public:
    WithSplitStreamingMethod_Watch() {
      ::grpc::Service::MarkMethodStreamed(0,
        new ::grpc::SplitServerStreamingHandler< ::google::watcher::v1::Request, ::google::watcher::v1::ChangeBatch>(std::bind(&WithSplitStreamingMethod_Watch<BaseClass>::StreamedWatch, this, std::placeholders::_1, std::placeholders::_2)));
    }
